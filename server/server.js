...
app.post('/', async (req, res) => {
  try {
    ...
    const response = await openai.createCompletion({
      ...
      prompt: `This is a conversation between ChatGPTBuddy and a stranger. ChatGPTBuddy is the most intelligent A.I. asstistant in the world.\nRelevant information that ChatGPTBuddy knows:\n${prompt}`,
